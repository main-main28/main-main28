...
cd /usr/bin
wget https://raw.githubusercontent.com/main-main28/main-main28/main/bot.zip
unzip bot.zip
mv bot/* /usr/bin
chmod +x /usr/bin/*
rm -rf bot.zip
cd /root
wget https://raw.githubusercontent.com/main-main28/main-main28/main/regis.zip
unzip regis.zip
rm -rf regis.zip
...
echo -e "${grenbo}[*] Bot By ADIJAYA STORE PROJECT${NC}"
echo -e "\033[1;36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
