...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/AdijayaTunneling/ip/main/vps | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/AdijayaTunneling/ip/main/vps | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/AdijayaTunneling/ip/main/vps | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/main-main28/main-main28/main/"
...
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/AdijayaTunneling/ip/main/vps | grep $ipsaya | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/AdijayaTunneling/ip/main/vps | grep $ipsaya | awk '{print $3}')
    TIMEZONE=$(printf '%(%H:%M:%S)T')
    TEXT="
<code>────────────────────</code>
<b>🍁AUTOSCRIPT PREMIUM VIP🍁</b>
<code>────────────────────</code>
...
"'&reply_markup={"inline_keyboard":[[{"text":"ORDER🐳","url":"https://t.me/AJSvpnjoss"},{"text":"GROUP🐬","url":"https://t.me/ConfigAdijaya"}]]}'
